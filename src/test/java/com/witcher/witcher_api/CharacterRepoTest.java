...
public class CharacterRepoTest {
    ...
    @Transactional
    public  void inic(){
       userRepositoryJdbc.insertUser(user_01);
        userRepositoryJdbc.insertUser(user_02);
        ...
        this.testCharacterId01 = characterRepository.insertCharacter(character_01.getName(), user_01.getId());
        this.testCharacterId02 = characterRepository.insertCharacter(character_02.getName(), user_02.getId());
    }
    ...
    public void testGetCharacter(){
        Character testCharacter = characterRepository.findCharacterById(testCharacterId01);
    ...
    public void testSaveCharacter() {
        ...
        testCharacterId01 = characterRepository.insertCharacter(testCharacter.getName(), user_01.getId());

        Character characterFromRepository = characterRepository.findCharacterById(testCharacterId01);
    ...
    public void testFindAllCharacters() {
        ...
        List<Character> characters = characterRepository.findAllCharacters(user_01.getId());
